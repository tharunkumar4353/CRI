...
@Component({
    selector: 'cycle2.component',
    templateUrl: './cycle2.component.html'
})
export class Cycle2Component implements OnInit {
  ...
  operatorName: string;
  processType: string;
  cnc03Data: any = {}; // To store data specifically for CNC-02
  customid: any;
  id: any;
  custcode: any;
  fgname: any;
  ...
  ngOnInit(): void {
    this.route.queryParams.subscribe(params => {
      ...
      this.machinename = params['machinename'] || 'CNC-03';
    ...
    this.socketService.getLiveData().subscribe((data: any) => {
      ...
      console.log('Real-time CNC-03 data:', this.cnc03Data);
    });
    }
  ...
  saveEmpAcceptCount(customid: string) {
    ...
    this.dataService.updateEmployeeAcceptCount(customid, this.empAcceptCount).subscribe(
      ...
      stopAndUpdateMachineMode2(machineName: string, processType: string, partId: string, processName: string, uniqid: any) {
