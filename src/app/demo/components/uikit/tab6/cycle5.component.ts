...
@Component({
    selector: 'cycle5.component',
    templateUrl: './cycle5.component.html'
})
export class Cycle5Component implements OnInit {
  uniqid: any;
  partName: string;
  partId: string;
  planquantity: number;
  ...
  processType: string;
    ...
    vmc01Data: any = {}; // To store data specifically for CNC-02
    id: any;
    customid: any;
    ...
    constructor(
      ...
      ngOnInit(): void {
        this.route.queryParams.subscribe(params => {
          ...
          this.machinename = params['machinename'] || 'VMC-01';
    ...
    this.socketService.getLiveData().subscribe((data: any) => {
      ...
      console.log('Real-time VMC-01 data:', this.vmc01Data);
    });
  ...
  stopAndUpdateMachineMode5(machineName: string, processType: string, partId: string, processName: string, uniqid: any) {
