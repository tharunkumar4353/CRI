...
@Component({
    selector: 'cycle6.component',
    templateUrl: './cycle6.component.html'
})
export class Cycle6Component implements OnInit {
  ...
  operatorName: string;
  processType: string;
    vmc02Data: any = {}; // To store data specifically for CNC-02
    id: any;
    custcode: any;
    fgname: any;
    customid: any;
    ...
    constructor(
      ...
      ngOnInit(): void {
        this.route.queryParams.subscribe(params => {
          ...
          this.machinename = params['machinename'] || 'VMC-02';
   ...
   this.socketService.getLiveData().subscribe((data: any) => {
    ...
    console.log('Real-time VMC-02 data:', this.vmc02Data);
  });
...
stopAndUpdateMachineMode6(machineName: string, processType: string, partId: string, processName: string, uniqid: any) {
