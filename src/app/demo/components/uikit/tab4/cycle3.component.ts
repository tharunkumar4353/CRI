...
@Component({
    selector: 'cycle3.component',
    templateUrl: './cycle3.component.html'
})
export class Cycle3Component implements OnInit {
  ...
  operatorName: string;
  processType: string;
  cnc04Data: any = {}; // To store data specifically for CNC-02
  id: any;
  customid: any;
  ...
  fgname: any;
    ...
    constructor(
      ...
      ngOnInit(): void {
        this.route.queryParams.subscribe(params => {
          ...
          this.machinename = params['machinename'] || 'CNC-04';
      ...
      this.socketService.getLiveData().subscribe((data: any) => {
        ...
        console.log('Real-time CNC-04 data:', this.cnc04Data);
      });
    ...
    stopAndUpdateMachineMode3(machineName: string, processType: string, partId: string, processName: string, uniqid: any) {
