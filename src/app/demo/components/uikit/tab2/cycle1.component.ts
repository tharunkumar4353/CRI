...
@Component({
  selector: 'cycle1-component',
  templateUrl: './cycle1.component.html'
})
export class Cycle1Component implements OnInit {
  uniqid: any;
  partName: string;
  partId: string;
  planquantity: number;
  ...
  ngOnInit(): void {
    this.route.queryParams.subscribe(params => {
      ...
      this.machinename = params['machinename'] || 'CNC-02';
    ...
    this.socketService.getLiveData().subscribe((data: any) => {
      ...
      console.log('Real-time CNC-02 data:', this.cnc02Data);
    });
  }
